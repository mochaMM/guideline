...
.. list-table::
   ...
   * - | (1)
     - | HTML form is constructed by using tag library. Specify the name of form object created by Controller in ``modelAttribute``.
       | Refer \ `here <http://docs.spring.io/spring/docs/3.2.18.RELEASE/spring-framework-reference/html/view.html#view-jsp-formtaglib-formtag>`_\ for tag library.
