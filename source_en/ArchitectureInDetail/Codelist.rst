...
This guideline recommends the method to reload the codelist periodically using \ `Spring Task Scheduler <http://docs.spring.io/spring/docs/3.2.18.RELEASE/spring-framework-reference/html/scheduling.html>`_\ .
